...
def main():
    ...
    # Classify strategy type (automatic, no config override needed)
    # Enhanced classification now handles regime-dependent strategies
    ...
    print(f"  Vol:                 ~10% (closed-loop targeting with 'always_on' method)")
    print(f"  Turnover:            ~580x (lower than V5)")
    print(f"  Activity:            ~72% (only in trending markets)")
    print(f"  Note:                V6 uses 'always_on' vol method despite lower activity")
