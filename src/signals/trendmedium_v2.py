# src/signals/trendmedium_v2.py
"""
TrendMedium v2 Signal Generator - PURE SIGNAL
----------------------------------------------
...
def generate_trendmedium_signal(
    ...
    """
    Generate TrendMedium v2 position signal - PURE STRATEGY LOGIC.
    ...
    Returns:
        pd.Series: Raw position signal (-1 to +1, typically -0.5 to +0.5 after filters)
    """
    ...
    # This is PURE STRATEGY LOGIC - no calibration
    pos_final = pos_raw * range_scale * quality_scale * vol_scale

    # Expected range: -0.5 to +0.5 (due to filters)
